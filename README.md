...
[English](README_HUGSIM.md) | [원본 DrivoR 프로젝트 README](README_DRIVOR.md)
...
원본 평가 스크립트)는 이 저장소의 원본 프로젝트 문서
[README_DRIVOR.md](README_DRIVOR.md)를 참고하세요 -- 여기서 중복 설명하지
않습니다.
...
기본 DrivoR/navsim 환경은 이 저장소의
[README_DRIVOR.md의 Installation](README_DRIVOR.md#installations) 절을
참고하세요. 실제로 이
